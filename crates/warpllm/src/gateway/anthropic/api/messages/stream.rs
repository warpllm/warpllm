...
/// to be completed from what `message_start` said.
...
pub(crate) fn ingest_event(
    ...
    match event {
        ...
        MessageStreamEvent::ContentBlockStop(_) | MessageStreamEvent::MessageStop(_) => None,
...
fn ingest_message_delta(event: MessageDeltaEvent, state: &StreamState) -> types::ChatResponseChunk {
    ...
    types::ChatResponseChunk {
        ...
        usage: Some(delta_usage(&usage, state)),
        ext: namespaced(chunk_ext),
        source: None,
    }
}
